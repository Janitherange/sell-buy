  ...
  <div class="col-md-12">
    <div class="row">
      <div class="col-md-6 col-md-offset-3">
        <div class="block text-center"> <a class="logo" href="index.jsp"> </a>
          <h2 class="text-center">Customer Feedback</h2>
          <form class="text-left clearfix" action="MainController">
            ...
            <div class="form-group">
              <input type="hidden" class="form-control"  value="feedback" name="key">
            </div>
            <div class="form-group">
              <input type="text" class="form-control"  placeholder="Description" height="200px" name="description">
            </div>
