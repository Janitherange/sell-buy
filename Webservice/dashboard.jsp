...
<head>
  ...
  <title> SellNBye E-Commerce System</title>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-4 col-xs-12 col-sm-4">
				<div class="contact-number"> <span></span></div>
			</div>
			<div class="col-md-4 col-xs-12 col-sm-4">
				<!-- Site Logo -->
						        ...
						        <g id="Group" transform="translate(-108.000000, -297.000000)" fill="#000000">
						            <text id="AVIATO">
						               <tspan x="108.94" y="325">
						                  <p align="center"><a name="_Hlk9064525"><strong>SellNBye</strong></a><strong>&nbsp;</strong><strong>E-Commerce System</strong><strong> </strong></p>
						                </tspan>
						            </text>
						        </g>
						    </g>
...
<ul class="dropdown-menu search-dropdown">
	          ...
	          <!-- Languages -->
	          <li class="commonSelect"> </li><!-- / Languages -->
				...
				<div class="dashboard-wrapper user-dashboard">
					<div class="media">
						...
						<div class="media-body">
							...
							<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Unde, iure, est. Sit mollitia est maxime! Eos cupiditate tempore, tempora omnis. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Enim, nihil. </p>
						</div>
					</div>
