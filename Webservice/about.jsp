		...
		<div class="row">
			<div class="col-md-3">
				<div class="team-member text-center">
					<img class="img-circle" src="images/team/Person_220px.png">
					<h4>Janith Eranga</h4>
					<p>Founder</p>
				</div>
			</div>
			...
			<div class="col-md-3">
				<div class="team-member text-center">
					<img class="img-circle" src="images/team/Person_220px.png">
					<h4>Tharindu pradeepa</h4>
					<p>Shop Manager</p>
				</div>
			</div>
			<div class="col-md-3">
				<div class="team-member text-center">
					<img class="img-circle" src="images/team/Person Female_220px.png">
					<h4>Adonija A.</h4>
					<p>Shop Manager</p>
				</div>
			</div>
