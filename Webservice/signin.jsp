    ...
    <div class="row">
      <div class="col-md-6 col-md-offset-3">
        <div class="block text-center">
          ...
          <img src="images/OpenCart_102px.png" alt="">
          ...
          <form class="text-left clearfix" action="MainController">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
              <input type="hidden" class="form-control"  value="register" name="key">
            </div>
            <div class="text-center">
             
               <input type="submit" class="btn btn-main text-center"  value="Sign In" >
            </div>
          </form>
