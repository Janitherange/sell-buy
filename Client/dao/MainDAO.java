...
public class MainDAO {
	...
	public static boolean feedbackDao(String id,String name, String email, String phone,String description) {
		try {
			String queryString = "insert into feedback(feedbackId,customerName,email,phone,description) values(?,?,?,?,?)";
	...
	public static boolean register(String name,String username, String email, String password) {
		try {
			String queryString = "insert into customer(customerName,customerUsername,customerEmail,customerPassword,customerAddress) values(?,?,?,?,?,?,?,?)";
			connection = getConnection();
			ptmt = connection.prepareStatement(queryString);
